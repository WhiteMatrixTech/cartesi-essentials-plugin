...
} from "@aurowallet/cartesi-provider";
...
export function DeployForm() {
  ...
  const onDeploy = useCallback(async () => {
    ...
    const cartesi = (window as any).cartesi;
    await timeout(1);
    if (cartesi == null) {
      return outputService.handleErrorSingle("Wallet not connected");
    }
    const publicKeyBase58: string = (await cartesi.requestAccounts())[0];
